...
class UserRedux extends Component {
    ...
    /**
     * xử lý thay đổi thông tin người dùng trong thẻ input
     * @param {*} event
     * @param {string} id key ứng với từng thông tin của người dùng(email, password....)
     */
    ...
    /**
     * validate trước khi tạo người dùng
     * @returns
     */
    checkValidateInput = () => {
        let isValid = true;
    ...
    /**
     * tạo/sửa người dùng bằng redux
     * @returns
     */
    handleSaveUser = () => {
        let isValid = this.checkValidateInput();
        console.log('check before save user', this.state);
        if (!isValid) return;
    ...
    /**
     * truyền hàm này xuống con để con gọi ngược hàm này lên cha
     * @param {obejct} user : thông tin người update
     */
